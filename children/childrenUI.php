...
if (!isset($child_id) && !isset($parent_id)) {
           ...
           <div class="row p-4">
               ...
               <div class="col-md-4">
                <div class="pray text-center  shadow-sm p-3 mb-5 bg-white rounded">
                  ...
                  <div class="col-md-4">
                    <div class="pray text-center  shadow-sm p-3 mb-5 bg-white rounded">
                      <img src="../images/logout.png" alt="image" height="120px"><br><br>
                      <form method="post" action="children_includes/logout.inc.php">
                        <button type="submit" name="logout" class="btn btn-primary py-2 px-8">Logout</button>
                      </form>
                    </div>
                </div>
           </div>
