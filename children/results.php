      	...
      	?>
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    <a href="result_display.php?id=<?php echo $parent_id.$question_id;?>&type=<?php echo $question_type;?>&question_id=<?php echo $question_id?>" class="btn btn-primary py-2 px-8">View Your Results</a>
                </div>
               </div>
            </div>    
       	<?php
